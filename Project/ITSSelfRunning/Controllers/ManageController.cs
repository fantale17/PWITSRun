...
using ITSSelfRunning.Models.ManageViewModels;
...
namespace ITSSelfRunning.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(
          ...
          UrlEncoder urlEncoder, IRunnerRepo runnerRepo, ICloudStorageService cloudStorageService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Name = runnerUser.Name,
                LastName = runnerUser.LastName,
                Sex = runnerUser.Sex,
                Birthday = runnerUser.Birthday,
                PhotoUri = runnerUser.PhotoUri
            };
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("ITSSelfRunning"),
